...
namespace Game.WorldObjects.Warehouse.Configuration
{
    ...
    public class WarehouseConfiguration : ScriptableObject, IWorldObjectConfiguration<IWorldObjectSettings>
    {
        ...
        public WarehouseSettings GetSettings(int level)
        {
            ...
            Debug.LogWarning(string.Format("Failed to find WarehouseSettings for level: {0}", level));
            return null;
        }
    }
}