...
namespace Game.WorldObjects.Elevator.Configuration
{
    ...
    public class ElevatorConfiguration : ScriptableObject, IWorldObjectConfiguration<IWorldObjectSettings>
    {
        ...
        public ElevatorSettings GetSettings(int level)
        {
            ...
            Debug.LogWarning(string.Format("Failed to find ElevatorSettings for level: {0}", level));
            return null;
        }
    }
}